...
def requirements(variables, age):
    ...
    if variables[2] >= 0.22 and variables[62] >= 1 and variables[57] == 0 and variables[4] == 0 and variables[7] == 0 and variables[10] == 0 and variables[14] == 0 and variables[17] == 0 and variables[21] == 0 and variables[26] == 0 and variables[30] == 0 and variables[34] == 0 and variables[38] == 0 and variables[41] == 0 and variables[46] == 0 and variables[50] == 0 and variables[65] == 0 and variables[67] == 0:
    ...
    if variables[2] >= 0.22 and variables[61] == 0 and variables[54] == 0 and variables[4] == 0 and variables[7] == 0 and variables[10] == 0 and variables[14] == 0 and variables[17] == 0 and variables[21] == 0 and variables[26] == 0 and variables[30] == 0 and variables[34] == 0 and variables[38] == 0 and variables[41] == 0 and variables[46] == 0 and variables[50] == 0 and variables[65] == 0 and variables[67] == 0:
    ...
    if variables[1] >= 0.11 and variables[1] < 0.22 and variables[59] == 0 and variables[54] == 0 and variables[3] == 0 and variables[56] == 0 and variables[4] == 0 and variables[7] == 0 and variables[10] == 0 and variables[14] == 0 and variables[17] == 0 and variables[21] == 0 and variables[26] == 0 and variables[30] == 0 and variables[34] == 0 and variables[38] == 0 and variables[41] == 0 and variables[46] == 0 and variables[50] == 0 and variables[65] == 0 and variables[67] == 0:
